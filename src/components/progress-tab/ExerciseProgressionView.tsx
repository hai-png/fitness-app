/**
 * ExerciseProgressionView — extracted from ProgressTab.tsx (A-04 decomposition).
 *
 * Sub-tab 3: exercise progression status, plateau watch, personal records,
 * set-by-set patterns feedback (AMRAP / Failure / Drop Set analysis), and
 * a smoothed-vs-raw SVG trend trajectory for the selected exercise.
 */
...
interface ExerciseProgressionViewProps {
  ...
  setSelectedAnalysisEx: (name: string) => void;
  isSmoothedTrend: boolean;
  setIsSmoothedTrend: (v: boolean) => void;
}

export default function ExerciseProgressionView({
  analytics,
  selectedAnalysisEx,

/**
 * Static data shared by the onboarding wizard steps.
 *
 * Extracted from Onboarding.tsx (A-05 god-component decomposition). Only
 * Step2Setting consumes these today, but they are kept in a dedicated module
 * so the data is trivially reusable (e.g. by tests or a future "edit gym"
 * modal) and so Onboarding.tsx is no longer burdened by ~115 lines of inline
 * data declarations.
 */

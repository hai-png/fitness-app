/**
 * DailyIntakeLogger — extracted from ProgressTab.tsx (A-01 god-component split).
 *
 * Feeds the adaptive TDEE engine with daily calorie + macro intake.
 * Required for the adaptive TDEE to converge from prior-heavy (formula-based)
 * to data-driven after ~30 days of paired intake+weight data.
 *
 * One entry per day — submitting overwrites today's log.
 */
...
export function DailyIntakeLogger() {
